locals {
  vpc_iam_role_name         = "${var.project_name}-${var.env}-VPC-Flow-Logs-Publisher-v2"
  vpc_iam_role_policy_name  = "${var.project_name}-${var.env}-VPC-Flow-Logs-Publish-Policy-v2"
  vpc_log_group_name        = "${var.project_name}-${var.env}-vpc-flow-logs-v2"
